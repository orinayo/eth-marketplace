...
const createFormState = (
  ...
  if (isNewPurchase) {
    if (confirmationEmail.length === 0 || email.length === 0) {
      ...
      return _createFormState(true, "Email do not match.");
    }
  }
...
export default function OrderModal({
  ...
  const { isDisabled, message: errorMessage } = createFormState(
    order,
    hasAgreedTOS,
    isNewPurchase
  );
            ...
            <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-1 relative rounded-md">
                    ...
                    <label className="flex items-center mr-2">
                      <input
                        ...
                        onChange={({ target: { checked } }) => {
                          setOrder({
                            ...order,
                            price: checked ? order.price : ethPerItem,
                          });
                ...
                <p className="text-xs text-gray-700">
                  ...
                  will be lower, order can be declined (&plusmn; 2% slippage is
                  allowed)
                </p>
              </div>
              {isNewPurchase && (
              ...
              <div className="text-xs text-gray-700 flex">
                ...
                <span>
                  ...
                  my order can be rejected if the data provided above is not
                  correct
                </span>
              </div>
              {errorMessage && (
